...
public class OrderMessagingDataMapper {
    ...
    public PaymentResponse paymentResponseAvroModelToPaymentResponse(PaymentResponseAvroModel paymentResponseAvroModel){
        return PaymentResponse.builder()
                ...
                .paymentStatus(com.food.ordering.system.valueobject.PaymentStatus.valueOf(
    ...
    public RestaurantApprovalResponse approvalResponseAvroModelToApprovalResponse(RestaurantApprovalResponseAvroModel
        ...
        return RestaurantApprovalResponse.builder()
                ...
                .orderApprovalStatus(com.food.ordering.system.valueobject.OrderApprovalStatus.valueOf(
