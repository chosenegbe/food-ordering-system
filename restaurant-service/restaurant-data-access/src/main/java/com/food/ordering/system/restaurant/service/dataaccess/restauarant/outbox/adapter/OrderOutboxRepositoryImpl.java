package com.food.ordering.system.restaurant.service.dataaccess.restauarant.outbox.adapter;

import com.food.ordering.system.outbox.OutboxStatus;
import com.food.ordering.system.restaurant.service.dataaccess.restauarant.outbox.exception.OrderOutboxNotFoundException;
import com.food.ordering.system.restaurant.service.dataaccess.restauarant.outbox.mapper.OrderOutboxDataAccessMapper;
import com.food.ordering.system.restaurant.service.dataaccess.restauarant.outbox.repository.OrderOutboxJpaRepository;
...
public class OrderOutboxRepositoryImpl implements OrderOutboxRepository {
    ...
    @Override
    public Optional<OrderOutboxMessage> findByTypeAndSagaIdAndOutboxStatus(String sagaType, UUID sagaId,
